...
int main()
{
    ...
    /* (so that you don't have to enter values if you don't have higher
   powers) */
    ...
    switch (highpower) {
        case 6:
            printf("enter coefficient of x power 6");
            scanf("%f", &p6);
        case 5:
            printf("enter coefficient of x power 5");
            scanf("%f", &p5);
        case 4:
            printf("enter coefficient of x power 4");
            scanf("%f", &p4);
        case 3:
            printf("enter coefficient of x power 3");
            scanf("%f", &p3);
        case 2:
            printf("enter coefficient of x power 2");
            scanf("%f", &p2);
        case 1:
            printf("enter coefficient of x (-9 to +9)");
            scanf("%f", &p1);
        case 0:
            printf("enter numeric constant");
            scanf("%f", &constval);
        default:
            printf("default");
    }
    ...
    printf("%f x**6+%f x**5+%f x**4+%f x**3 +%f x**2 %f x= %f\n", p6, p5,
           p4, p3, p2, p1, constval);
    /* Your curve should cross the x-axis */
    /* Here, your lower value is a value of x where your curve is below
   the x-axis */
    /* Your upper value is a value of x where your curve is above the
   x-axis */
